...
// Validate ../../app/api/sendForms/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/sendForms">> = Specific
  const handler = {} as typeof import("../../app/api/sendForms/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
